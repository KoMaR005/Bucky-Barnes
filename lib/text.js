...
*СОЗДАТЕЛЬ ТЕКСТА*
⿻${prefix}логотипволка _text1|text2_
⿻${prefix}логотипмстителя _text1|text2_
⿻${prefix}phlogo _text1|text2_
⿻${prefix}логотипmarvel _text1|text2_
⿻${prefix}gtext _text1|text2_
⿻${prefix}pubgлоготип _text1|text2_
⿻${prefix}снеграйт _text1|text2_
⿻${prefix}акварель _text1|text2_
⿻${prefix}harta _text_
